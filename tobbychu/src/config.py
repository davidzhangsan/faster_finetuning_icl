...
# Optimizer hps (modified to include momentum params)
config.adam = True  # Set to False to use SGD with momentum
config.b1 = 0.9
config.b2 = 0.98
config.adam_eps = 1e-09
config.momentum = 0.9  # Added: momentum value for SGD
config.nesterov = True  # Added: whether to use Nesterov momentum
config.flip = False
